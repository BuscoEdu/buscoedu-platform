...
export default function UniversidadesLanding() {
  ...
  return (
    <div className="bg-gradient-to-b from-white to-buscoedu-bg">
      ...
      <div className="mx-auto max-w-7xl space-y-16 px-4 py-10 sm:px-6 lg:px-8">
        {/* 1) HERO */}
        <section className="rounded-3xl border border-buscoedu-border bg-white p-6 shadow-card sm:p-10">
          <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-start">
            <div>
              ...
              <div className="mt-8 grid gap-2 sm:grid-cols-2">
                {confianza.map((item) => (
                  <div key={item} className="rounded-lg border border-buscoedu-border bg-buscoedu-bg px-3 py-2 text-sm font-medium text-buscoedu-text">
                    {item}
                  </div>
                ))}
              </div>
            ...
            <div className="space-y-4">
              <div className="rounded-2xl border border-buscoedu-border bg-buscoedu-bg p-4">
              ...
              <div className="rounded-2xl border border-buscoedu-border bg-white p-4">
        ...
        <section className="space-y-5">
          ...
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            {pilares.map((pilar) => (
              <div key={pilar.titulo} className="rounded-2xl border border-buscoedu-border bg-white p-5 shadow-card">
        ...
        <section className="space-y-5">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {[
              ...
              <div key={paso} className="flex gap-3 rounded-xl border border-buscoedu-border bg-white p-4">
          ...
          <div className="rounded-2xl border border-buscoedu-border bg-white p-6 shadow-card">
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                <div key={item} className="rounded-lg border border-buscoedu-border bg-buscoedu-bg px-3 py-2 text-sm text-buscoedu-text">
                  {item}
                </div>
              ))}
            </div>
        ...
        <section className="space-y-5 rounded-2xl border border-buscoedu-teal/25 bg-buscoedu-teal/5 p-6">
        ...
        <section className="space-y-5">
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {beneficios.map((beneficio) => (
              <div key={beneficio} className="rounded-xl border border-buscoedu-border bg-white p-4 shadow-card">
        ...
        <section className="space-y-5">
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div key={kpi} className="rounded-lg border border-buscoedu-border bg-white px-3 py-2 text-sm text-buscoedu-text">
                {kpi}
              </div>
            ))}
          </div>
        ...
        <section className="space-y-5">
          ...
          <div className="space-y-3">
            {faqItems.map((item, index) => {
              ...
              return (
                <article key={item.q} className="rounded-xl border border-buscoedu-border bg-white">
                  <button
                    type="button"
        ...
        {/* 13) FORMULARIO + CTA FINAL */}
        <section id="form-alianza" className="rounded-3xl border border-buscoedu-border bg-white p-6 shadow-card sm:p-8">
...
function CardNivel({ titulo, bullets }: { titulo: string; bullets: string[] }) {
  return (
    <article className="rounded-2xl border border-buscoedu-border bg-white p-5 shadow-card">
